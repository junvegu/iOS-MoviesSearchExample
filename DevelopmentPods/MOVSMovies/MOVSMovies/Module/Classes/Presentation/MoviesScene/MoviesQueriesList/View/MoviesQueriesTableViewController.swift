...
final class MoviesQueriesTableViewController: UITableViewController, StoryboardInstantiable {
    ...
    static func create(with viewModel: MoviesQueryListViewModel) -> MoviesQueriesTableViewController {
        ...
        let view = UIStoryboard.init(name: "MoviesQueriesTable", bundle: Bundle(for: Self.self).resource).instantiateViewController(withIdentifier: "MoviesQueriesTableViewController") as! MoviesQueriesTableViewController
