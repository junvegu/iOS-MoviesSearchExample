...
final class MoviesListViewController: UIViewController, StoryboardInstantiable, Alertable {
    ...
    static func create(with viewModel: MoviesListViewModel,
        ...
        let view = UIStoryboard.init(name: "MoviesList", bundle: Bundle(for: Self.self).resource).instantiateViewController(withIdentifier: "MoviesListViewController") as! MoviesListViewController
