...
public protocol Requestable {
    ...
    func urlRequest(with networkConfig: MOVSNetworkingSettings) throws -> URLRequest
}
...
extension Requestable {
    ...
    func url(with config: MOVSNetworkingSettings) throws -> URL {

        let baseURL = config.base.absoluteString.last != "/" ? config.base.absoluteString + "/" : config.base.absoluteString
    ...
    public func urlRequest(with config: MOVSNetworkingSettings) throws -> URLRequest {
